    ...
    <nav className="flex items-center justify-between px-4 py-4 md:px-6 lg:px-8">
      ...
      <div className="flex items-center">
        <Link to="/" className="flex items-center gap-2">
          <div className="relative h-10 w-10">
            ...
            >
              ...
              <path
                ...
                fill="currentColor"
              />
              <path d="M13 8C13 9.1 12.1 10 11 10C9.9 10 9 9.1 9 8C9 6.9 9.9 6 11 6C12.1 6 13 6.9 13 8Z" fill="white" />
              <path
          ...
          <span className="text-xl font-bold text-green-600">CopperConnect</span>
        </Link>
      </div>

      {/* Desktop Navigation */}
      <div className="hidden items-center space-x-8 md:flex">
        <Link to="/" className="text-base font-medium text-gray-800 hover:text-green-600">
          Home
        </Link>
        <DropdownMenu>
        ...
        <Link to="/blog" className="text-base font-medium text-gray-800 hover:text-green-600">
          Blog
        </Link>
        <Link to="/pricing" className="text-base font-medium text-gray-800 hover:text-green-600">
          Pricing
        </Link>
      </div>
      ...
      <div className="hidden items-center space-x-4 md:flex">
        <Button variant="outline" className="border-green-600 text-green-600 hover:bg-green-50 hover:text-green-700 cursor-pointer">
          Login
        </Button>
        <Button className="bg-green-600 text-white hover:bg-green-700 cursor-pointer">Sign Up</Button>
      </div>
        ...
        <div className="absolute left-0 top-16 z-10 w-full bg-white p-4 shadow-lg md:hidden">
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-col space-y-2 pt-2">
              ...
              <Button className="w-full bg-green-600 text-white hover:bg-green-700" onClick={() => setIsOpen(false)}>
                Sign Up
              </Button>
            </div>
          </div>
