    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        <div className="flex flex-col items-center">
          {/* Logo */}
          <div className="h-16 w-16 text-green-700">
        ...
        <div className="mt-8">
          ...
          <button
            ...
            disabled={loading}
            className="group relative flex w-full justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50"
          >
          ...
          <form className="mt-6 space-y-6" onSubmit={handleEmailSignIn}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link to="./ResetPassword.tsx" className="font-medium text-green-600 hover:text-green-500">
                  Forgot Password?
                </Link>
              </div>
            </div>
